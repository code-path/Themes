...
<section class="sidebox social_buttons">
	...
	<div class="sidebox_body">
		{if $social['facebook']['enabled']}
			<a href="{$social['facebook']['link']}" target="_blank" class="social_btn facebook_btn anti_blur">
		...
		{if $social['twitter']['enabled']}
			<a href="{$social['twitter']['link']}" target="_blank" class="social_btn twitter_btn anti_blur">
				<div class="social_btn_icon"></div>
		...
		{if $social['youtube']['enabled']}
			<a href="{$social['youtube']['link']}" target="_blank" class="social_btn youtube_btn anti_blur">
				<div class="social_btn_icon"></div>
